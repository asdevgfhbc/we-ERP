...
const pageCatalog: CatalogItem[] = [
  ...
  { module: 'Sales & Distribution', title: 'Invoices', kind: 'table', entity: 'invoice', subtitle: 'Invoice list with dues, settlements, and VAT visibility.' },
  ...
  { module: 'Purchasing / Import', title: 'Purchase Details', kind: 'detail', entity: 'purchase-order', subtitle: 'Purchase order details and receiving progress.' },
  { module: 'Purchasing / Import', title: 'GRN (Goods Receiving)', kind: 'table', entity: 'grn', subtitle: 'Receiving notes and inbound stock reconciliation.' },
  ...
  { module: 'Purchasing / Import', title: 'Customs & Duty Records', kind: 'table', entity: 'customs-duty', subtitle: 'Customs declarations and duty/tax calculations.' },
  ...
  { module: 'Warehouse', title: 'Goods Receiving', kind: 'form', entity: 'grn', subtitle: 'Receive and inspect incoming goods.' },
  ...
  { module: 'Warehouse', title: 'Stock Transfer', kind: 'form', entity: 'stock-transfer', subtitle: 'Move stock between warehouses or branches.' },
  { module: 'Warehouse', title: 'Stock Adjustment', kind: 'form', entity: 'stock-adjustment', subtitle: 'Record manual corrections and write-offs.' },
